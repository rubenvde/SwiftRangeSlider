...
@IBDesignable open class RangeSlider: UIControl {
  ...
  open func updateLabelText() {
    ...
    lowerLabelTextSize = (lowerLabel.string as! NSString).size(withAttributes: convertToOptionalNSAttributedStringKeyDictionary([convertFromNSAttributedStringKey(NSAttributedString.Key.font) : UIFont.systemFont(ofSize: labelFontSize)]))
    upperLabelTextSize = (upperLabel.string as! NSString).size(withAttributes: convertToOptionalNSAttributedStringKeyDictionary([convertFromNSAttributedStringKey(NSAttributedString.Key.font) : UIFont.systemFont(ofSize: labelFontSize)]))
  }
